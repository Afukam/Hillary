...
def mac_change(interface, new_mac):
    print(
        f"[+]Changing the MAC address for {interface} to {new_mac} , feel free to grab a coffee or tea, while the "
        f"change is in progress")
    try:
        ...
        print(
            "[-] Oops, An error occurred while changing the MAC address. Try again, but make sure you have root "
